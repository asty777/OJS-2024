        ...
        <>
            <div class=" bg-slate-100 p-32 ">
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <ul class="flex flex-wrap justify-center text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                       <li class="me-2">
                        ...
                        <li class="me-2">
                            <Link to="/user/profile/notification" class="inline-flex items-center justify-center p-4 text-sky-800 border-b-2 border-sky-800 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group" aria-current="page">
                ...
                <div class="p-12  mx-auto bg-slate-100 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-fit">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-8 hover:border-b-2 border-sky-800 inline-block">Profile / <span className="text-sky-800">Notifications</span></h3>
                    <div class="w-full  bg-white rounded-lg shadow  dark:border md:mt-0 sm:max-w-2xl xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div class="p-6 space-y-4 md:space-y-6  sm:p-8">
                            ...
                            <h3 class="mb-4  font-normal text-gray-700 dark:text-white">Select the system events that you wish to be notified about. Unchecking an item will prevent notifications of the event from showing up in the system and also from being emailed to you. Checked events will appear in the system and you have an extra option to receive or not the same notification by email.</h3>
                               <div>
                                    <h3 class="mb-4  border-b-2 border-sky-800 inline-block font-semibold text-gray-900 dark:text-white">Public Announcements</h3>
                                    <h3 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">New announcement</h3>
                                    <div class="flex items-center mb-4 ">
                                        <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label for="default-checkbox" class=" ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Enable these types of notifications.</label>
                                    </div>
                                    <div class="flex items-center">
                                         <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label for="default-checkbox" class=" ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Do not send me an email for these types of notifications.</label>
                                    </div>
                               </div>

                               <div>
                                    <h3 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">An issue has been published.</h3>
                                    <div class="flex items-center mb-4 ">
                                        <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label for="default-checkbox" class=" ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Enable these types of notifications.</label>
                                    </div>
                               ...
                               <div>
                                    <h3 class="mb-4  border-b-2 border-sky-800 inline-block font-semibold text-gray-900 dark:text-white">Submission Events</h3>
                                    <h3 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">A new article, "Title," has been submitted.</h3>
                                    <div class="flex items-center mb-4 ">
                                        <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label for="default-checkbox" class=" ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Enable these types of notifications.</label>
                                    </div>
                               ...
                               <div>
                                    <h3 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">A new article has been submitted to which an editor needs to be assigned.</h3>
                                    <div class="flex items-center mb-4 ">
                                        <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label for="default-checkbox" class=" ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Enable these types of notifications.</label>
                                    </div>
                               ...
                               <div>
                                    <h3 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">"Title's" metadata has been modified.</h3>
                                    <div class="flex items-center mb-4 ">
                                        <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label for="default-checkbox" class=" ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Enable these types of notifications.</label>
                                    </div>
                               ...
                               <div>
                                    <h3 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Discussion added.</h3>
                                    <div class="flex items-center mb-4 ">
                                        <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label for="default-checkbox" class=" ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Enable these types of notifications.</label>
                                    </div>
                               ...
                               <div>
                                    <h3 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Discussion activity.</h3>
                                    <div class="flex items-center mb-4 ">
                                        <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label for="default-checkbox" class=" ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Enable these types of notifications.</label>
                                    </div>
                               ...
                               <div>
                                    <h3 class="mb-4  border-b-2 border-sky-800 inline-block font-semibold text-gray-900 dark:text-white">Reviewing Events</h3>
                                    <h3 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">A reviewer has commented on "Title".</h3>
                                    <div class="flex items-center mb-4 ">
                                        <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label for="default-checkbox" class=" ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Enable these types of notifications.</label>
                                    </div>
