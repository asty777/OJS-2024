        ...
        <div class=" bg-slate-100 p-32 ">
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <ul class="flex flex-wrap justify-center text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                        ...
                        <li class="me-2">
                            <Link to="/user/profile/APiKey" class="inline-flex items-center justify-center p-4 text-sky-800 border-b-2 border-sky-800 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group" aria-current="page">
                ...
                <div class="p-12  mx-auto bg-slate-100 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-fit">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-8 hover:border-b-2 border-sky-800 inline-block">Profile / <span className="text-sky-800">API Key</span></h3>
                            ...
                            <form class="space-y-4 md:space-y-6" action="#">
                               <div>
                                    <div class="flex items-center mb-4 ">
                                        ...
                                        <label for="default-checkbox" class=" ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Enable external applications with the API key to access this account</label>
                                    </div>
                                    <div class="flex items-center">
                                         <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        <label for="default-checkbox" class=" ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Generate new API key</label>
                                    </div>
                               </div>
                               <div>
                               <label for="givenName" class="block mb-2 text-sm font-normal text-gray-700 dark:text-white">Generating a new API key will invalidate any existing key for this user.</label>
                                    ...
                                    <p class="text-sm font-normal mt-2 italic text-gray-500 dark:text-gray-400">
                                       API Key
                                    </p>
                                </div>
...
export default ComProfileAPiKey;