            ...
            <div class=" bg-slate-100 p-32 ">
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <ul class="flex flex-wrap justify-center text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                        ...
                        <li class="me-2">
                            <Link to="/user/profile/role" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-sky-800 hover:border-sky-800 dark:hover:text-gray-300 group" aria-current="page">
                        ...
                        <li class="me-2">
                            <Link to="/user/profile/password" class="inline-flex items-center justify-center p-4 text-sky-800 border-b-2 border-sky-800 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group" aria-current="page">
                ...
                <div class="p-12  mx-auto bg-slate-100 text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 rounded-lg w-fit">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-8 hover:border-b-2 border-sky-800 inline-block">Profile / <span className="text-sky-800">Password</span></h3>
                        <div class="w-full  bg-white rounded-lg shadow  dark:border md:mt-0 sm:max-w-2xl xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                            <div class="p-6 space-y-4 md:space-y-6  sm:p-8">
                                <form class="space-y-4 md:space-y-6" action="#">
                                    <div class="flex i p-4 mb-4 text-sm text-blue-800 rounded-lg shadow-sm bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
                                    ...
                                    <div>
                                        ...
                                        <input type="new-password" name="new-password" id="new-password" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="xxx" required=""/>
                                        <p class="text-sm font-normal mt-2 italic text-gray-700 dark:text-gray-400">
                                   ...
                                   <div>
                                    ...
                                    <button type="submit" class="inline-flex mr-3 items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-sky-800 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
                                        Save
                                    </button>
                                    <button type="cancel" class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-rose-600 border border-gray-300 bg-white hover:bg-gray-100 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 ">
                                        Cancel
                                    </button>
